<html>
    <head>
        <meta charset="utf-8">
        <title>Menú gestion de Proveedores</title>
        <link rel="stylesheet" href="estiloGprov.css">
        <style>
            /* ========================================
            RESET BÁSICO
            ======================================== */
            ...
            * {
            ...
            h1 {
                ...
                margin-bottom: 40px; /* Espaciado inferior de 40px */
            ...
            /* Estiliza cada formulario individual */
            form {
                width: 100%; /* Ocupa el 100% del ancho disponible */
                max-width: 450px; /* Ancho máximo de 450px */
                margin-bottom: 20px; /* Espaciado inferior de 20px entre formularios */
            }
            ...
            input[type="submit"] {
                ...
                padding: 18px 35px; /* Relleno interno: 18px arriba/abajo, 35px izq/der */
                ...
                transition: all 0.3s ease; /* Transición suave de 0.3 segundos para todas las propiedades */
                position: relative; /* Posicionamiento relativo para elementos pseudo */
                overflow: hidden; /* Oculta contenido que se salga del botón */
                box-shadow: 0 8px 20px rgba(0, 0, 0, 0.2); /* Sombra para dar efecto de profundidad */
                font-family: inherit; /* Hereda la fuente del body */
            }

            /* Pseudo-elemento para crear efecto de brillo deslizante en todos los botones */
            input[type="submit"]::before {
                ...
                width: 100%; /* Ancho del 100% del botón */
                height: 100%; /* Alto del 100% del botón */
            ...
            /* Activa el efecto de brillo al pasar el mouse sobre cualquier botón */
            input[type="submit"]:hover::before {
                left: 100%; /* Mueve el brillo de izquierda a derecha */
            }

            /* Efecto hover general (al pasar el mouse sobre cualquier botón) */
            input[type="submit"]:hover {
                transform: translateY(-4px); /* Eleva el botón 4px hacia arriba */
            }

            /* Efecto active general (al hacer clic en cualquier botón) */
            input[type="submit"]:active {
                transform: translateY(-1px); /* Reduce la elevación a solo 1px */
            }

            /* ========================================
            BOTÓN "AGREGAR PRODUCTO" - VERDE
            ======================================== */

            #btnAg {
                background: linear-gradient(135deg, #48bb78 0%, #38a169 100%); /* Gradiente verde diagonal */
            }

            /* Efecto hover específico del botón Agregar */
            #btnAg:hover {
                box-shadow: 0 15px 35px rgba(72, 187, 120, 0.5); /* Sombra verde al hacer hover */
            }

            /* ========================================
            BOTÓN "MODIFICAR PRODUCTO" - AZUL
            ======================================== */
            ...
            /* Efecto hover específico del botón Modificar */
            #btnMod:hover {
                box-shadow: 0 15px 35px rgba(66, 153, 225, 0.5); /* Sombra azul al hacer hover */
            }
            ...
            a {
                ...
                backdrop-filter: blur(10px); /* Efecto de desenfoque del fondo (glassmorphism) */
    ...
    <body>
        ...
        <form action="agregarProv/agregarProveedor.php">
            <input type="submit" id="btnAg" value="Agregar Proveedor">
        </form>

         <form action="modProv/modifProv.php">
            <input type="submit" id="btnMod" value="Modificar Proveedor">
        </form>
        <a href="../menu.php">Volver al menú de opciones</a>
    </body>
</html>